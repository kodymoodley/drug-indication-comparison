...
sub queryWebInterface
{
    ...
    my $qurl = "$url/cgi-bin/umls_similarity/umls_similarity.cgi?word1=$i1&word2=$i2&sab=$sab&rel=$rel&similarity=$smeasure&button=$button&sabdef=$sabdef&reldef=$reldef&relatedness=$rmeasure";
